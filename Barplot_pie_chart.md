...
pie(smoke_tab,labels=c("No","Yes"),col=c("orange","pink"),main = " Smoking habit")
```
...
```{r}
pie(freq_tab,labels = c("Female","Male"),col = c("blue","pink"),main="Gender distribution in the Data")
```
